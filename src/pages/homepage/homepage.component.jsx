    ...
    <div className="homepage">
        <Header Header_image={Header_image}>
            <h1 style={{color :'white',fontSize: '50px'}}>
                ...
                <p style={{fontSize: '40px',textAlign: 'center'}}>Don't worry We Type For You.</p><br></br>
                <div align="right" id="main"><Link className="button" to="/about">Type for Me</Link></div>
        </Header>
        ...
        <div className="features">
            <div className="blocks">
                <div className="para">
                    ...
                    <div className="forScroll"><a href="#coin" className="scroll button">Learn About Coins</a></div>
                </div>
                <img src={require('../../assets/home-you.jpg')} alt="why"/>
            </div>
            <div className="blocks">
                <img src={require('../../assets/home-notes.jpg')} alt="why"/>
                <div className="para">
            ...
            <div className="blocks">
                <div className="para">
                    <h1>Why Choose Us ?</h1>
                    <p>The document is typed by People who take this work seriously and as a profession. So, you can expect perfection instead of something done by AI which has many imperfections. We strive to deliver quality with our work and will always push past our limits to deliver it.</p>
                </div>
                <img src={require('../../assets/home-why.jpg')} alt="why"/>
            </div>
        </div>
        <div id="how-to" className="main-heading" style={{backgroundColor: 'rgb(255, 236, 218)',}}>
            <h1>How to upload Your documents ?</h1>
        </div>
        <div className="features">
            <div className="blocks">
            <img src={require('../../assets/home-log.jpg')} alt="why"/>
            <div className="para">
            ...
            <img src={require('../../assets/home-prof.jpg')} alt="why"/>
            </div>
            <div className="blocks">
            <img src={require('../../assets/home-upl.jpg')} alt="why"/>
            <div className="para">
            ...
            <img src={require('../../assets/home-relax.jpg')} alt="why"/>
            </div>
        </div>
        <div id="coins" className="main-heading" style={{backgroundColor: 'rgb(198, 253, 196)',}}>
            <h1>Payment ? Coins ?</h1>
        </div>
        <div className="features">
            <div className="blocks">
                <img src={require('../../assets/home-pay.jpg')} alt="why"/>
                <div className="para">
            ...
            <img src={require('../../assets/home-coins.jpg')} alt="why"/>
            </div>
        </div>
        <div id="typer" className="main-heading" style={{backgroundColor: 'rgb(255, 208, 208)',}}>
            <h1>Wanna Become a Typer ?</h1>
        </div>
        <div className="features">
            <div className="blocks">
            <img src={require('../../assets/home-apply.jpg')} alt="why"/>
            <div className="para">
                <h1>How to Apply</h1>
            ...
            <img src={require('../../assets/home-caut.jpg')} alt="why"/>
            </div>
            <div className="blocks">
            <img src={require('../../assets/home-payment.jpg')} alt="why"/>
            <div className="para">
